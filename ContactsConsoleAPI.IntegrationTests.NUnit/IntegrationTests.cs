...
namespace ContactsConsoleAPI.IntegrationTests.NUnit
{
    public class IntegrationTests
    {
        ...
        {
            var expection = Assert.ThrowsAsync<KeyNotFoundException>(() => contactManager.SearchByFirstNameAsync("NO_SUCH_KEY"));

            Assert.That(expection.Message, Is.EqualTo("No contact found with the given first name."));
        }
        ...
        {
            var expection = Assert.ThrowsAsync<KeyNotFoundException>(() => contactManager.SearchByLastNameAsync("NO_SUCH_KEY"));

            Assert.That(expection.Message, Is.EqualTo("No contact found with the given last name."));
        }
